...
export const metadata: Metadata = {
  ...
  description: "Explore the exquisite collection of gold jewellery from Oswal Alankar.",
}
    ...
    <div className="bg-stone-50">
      ...
      <section className="relative w-full py-24 md:py-32 overflow-hidden bg-gradient-to-br from-amber-50 to-stone-100">
        ...
        <div className="relative z-10 container px-4 md:px-6 text-center text-stone-900">
          ...
          <p className="text-xl md:text-2xl text-stone-700 leading-relaxed mt-4 max-w-3xl mx-auto animate-fade-in delay-200">
            Immerse yourself in the timeless allure of our meticulously crafted gold jewellery. Each piece reflects
            purity and unparalleled artistry.
          </p>
        </div>
      </section>
      ...
      <div className="container px-4 md:px-6 py-16 md:py-24">
        ...
        <div className="flex justify-between items-center mb-8 animate-fade-in-up delay-300">
          <h2 className="text-2xl font-serif font-bold text-stone-800">All Gold Jewellery</h2>
          <div className="flex gap-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem>By Type (Necklace, Ring, etc.)</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
        ...
        {/* Call to Action for Custom Gold */}
        <section className="mt-20 bg-amber-700 text-amber-50 p-12 rounded-lg shadow-xl text-center animate-fade-in-up delay-500">
          <div className="space-y-6">
            <h2 className="text-4xl font-serif font-bold leading-tight">Design Your Dream Gold Piece</h2>
            <p className="text-lg max-w-3xl mx-auto">
              Can&apos;t find exactly what you&apos;re looking for? Our artisans can create a bespoke gold masterpiece
              just for you.
            </p>
            <Button
              asChild
            ...
            >
              <Link href="/contact">Inquire About Custom Gold</Link>
            </Button>
          </div>
        </section>
      </div>
